package com.reavture.funfactory;

//Factories create an object w/o exposing
//creation logic to client
public class HondaFactory {
	/*
	 * use a "factory" method to return a Car Model based on what String is given if
	 * the method is given a parameter of something besides crv or civic, it will
	 * return null
	 */
