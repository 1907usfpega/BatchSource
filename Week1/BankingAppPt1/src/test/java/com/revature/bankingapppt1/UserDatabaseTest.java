...
class UserDatabaseTest {
	...
	void printDatabaseTest() {
		assertEquals(userDB.printDatabase(),
				"| LeviApplebaum | password123 | Admin | Pending | []\n");
	}
	@Test
	...
	void getUserTest() {
		...
		User testUser = new User("ArtFisher", "Qualish", "Customer");
	...
	void getAllPendingTest() {
		...
		assertEquals(temp, userDB.getAllPending());		
	}
}
