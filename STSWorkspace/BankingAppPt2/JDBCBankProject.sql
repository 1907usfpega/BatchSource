...
CREATE OR REPLACE PROCEDURE UPDATEUSERACCOUNT(U_ID IN NUMBER, NEWFIRSTNAME IN VARCHAR2, NEWLASTNAME IN VARCHAR2, NEWUSERNAME IN VARCHAR2, NEWPASSWORD IN VARCHAR2) IS
BEGIN
    UPDATE BANKUSERS SET USER_USERNAME = NEWUSERNAME, USER_PASSWORD = NEWPASSWORD, USER_FIRSTNAME = NEWFIRSTNAME, USER_LASTNAME = NEWLASTNAME WHERE USER_ID = U_ID;
END;
/
