...
public static Scanner scan = new Scanner(System.in);
	public static void main(String[] args) {
		...
		try {
			System.out.println();
			System.out.println("                  W e l c o m e    t o    G R E E N L A N D   B a n k i n g   ");
			System.out.println("              ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^");
			System.out.println("              ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^ ^^^^");
			System.out.println();
			boolean open = true;
			while(open) {
				System.out.println("                  BANKING                        NEW ACCOUNT  ");
				System.out.println();
				System.out.println();
				...
				switch(choice.toUpperCase()) {
					...
					case "ACCOUNT":
						...
						System.out.println("  Thank you "+ FirstName +" "+ lastName +", the minimum deposit is $500.00.\n  Please enter the amount of your initial deposit.");
					    ...
					    System.out.println("  You have SUCCESSFULLY banked with GREENLAND Banking "+lastName);
					    cust.getCustomer(g);
					    System.out.println("");
					    System.out.println("    \\^/\\^/\\^/\\^/\\^/\\^/\\^/\\^/\\^/\\^/\\^/\\^/ \n ");
						break;
