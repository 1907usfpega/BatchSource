...
public class ZipCodeService {
	...
	public Response createZipCode(ZipCode z) {
		...
		return Response.status(Response.Status.OK).entity("Zipcode " + z.getZipCode() + " was added successfully").build();
	}
	...
	@DELETE
	@Path("/{zipCode}")
	public Response deleteZipCode(@PathParam("zipCode")int zipcode) {
		ZipCodeDaoImpl.removeZipCode(zipcode);
		System.out.println("Deleted Zip Code " + zipcode);
